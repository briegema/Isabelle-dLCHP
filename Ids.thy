...
abbreviation ch1::chan where "ch1 \<equiv> ChanName (CHR ''9'')"
...
abbreviation rec::tvar where "rec \<equiv> TVarName (CHR ''h'')"
abbreviation his::tvar where "his \<equiv> TVarName (CHR ''w'')"
abbreviation hid0::tvar where "hid0 \<equiv> TVarName (CHR ''r'')"
abbreviation hid'::tvar where "hid' \<equiv> TVarName (CHR ''i'')"
